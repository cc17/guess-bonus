(function(global) {
    function PxLoader(settings) {
        ...
        var ResourceState = {QUEUED: 0,WAITING: 1,LOADED: 2,ERROR: 3,TIMEOUT: 4};
        ...
        this.add = function(resource) {
            ...
            entries.push({resource: resource,status: ResourceState.QUEUED})
        };
        this.addProgressListener = function(callback, tags) {
            progressListeners.push({callback: callback,tags: new PxLoaderTags(tags)})
        };
        this.addCompletionListener = function(callback, tags) {
            progressListeners.push({tags: new PxLoaderTags(tags),callback: function(e) {
        ...
        var sendProgress = function(updatedEntry, listener) {
            ...
            listener.callback({resource: updatedEntry.resource,loaded: (updatedEntry.status === ResourceState.LOADED),error: (updatedEntry.status === ResourceState.ERROR),timeout: (updatedEntry.status === ResourceState.TIMEOUT),completedCount: completed,totalCount: total})
        };
...
;
/*  |xGv00|f333c5c9cdeea535d4fbba00f90f55cf */